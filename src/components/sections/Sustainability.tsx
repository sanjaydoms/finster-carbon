      ...
      <div className="mx-auto max-w-page px-5 sm:px-8">
        ...
        <ol className="mt-16 border-t border-paper/15">
          ...
          <Reveal as="li" key={focus.title} delay={i * 0.06}>
              <div className="group grid items-baseline gap-4 border-b border-paper/15 py-8 transition-colors duration-150 ease-out hover:bg-sage-200 lg:grid-cols-12 lg:gap-10 lg:px-2">
                <h3 className="t-sub text-paper lg:col-span-5">{focus.title}</h3>
                <p className="text-base leading-relaxed text-paper/65 lg:col-span-7">
                  {focus.body}
                </p>
              </div>
            </Reveal>
