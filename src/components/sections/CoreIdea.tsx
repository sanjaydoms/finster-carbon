      ...
      <div className="mx-auto max-w-page px-5 sm:px-8">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-12 lg:gap-14">
          <SplitHeading
            ...
            className="t-major text-paper lg:col-span-7" />
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          <Reveal key={panel.code} delay={i * 0.06} className="h-full">
              <article className="group flex h-full flex-col overflow-hidden rounded-sm bg-ground">
                ...
                <div className="flex flex-1 flex-col p-6 sm:p-8">
                  <div className="flex items-start justify-between gap-6">
                    <h3 className="display text-[clamp(1.6rem,2.8vw,2.25rem)] text-paper">
                      {panel.title[0]}
                      <br />
                      {panel.title[1]}
                    </h3>
                    <span className="micro mt-2 shrink-0 border border-amber/40 px-3 py-1.5 text-amber-300">
                      {panel.code}
                    </span>
                  </div>
                  <p className="mt-5 text-sm leading-relaxed text-paper/65 sm:text-base">
                    {panel.body}
                  </p>
